...
export default async function HouseholdHistoryPage({ params }: { params: Promise<{ household: string }> }) {
  ...
  return <HistoryClient transactions={transactions} categories={categories} templates={templates} memberNames={memberNames} householdId={householdId} basePath={basePath} />;
}
